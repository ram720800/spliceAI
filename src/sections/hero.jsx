      ...
      <Element name="hero">
        <div className="container">
          <div className="relative z-2 max-w:512 max-lg:max-w-388 text-left">
            ...
            <h1 className="h2 mb-6 text-p4 uppercase max-lg:mb-7 max-lg:h2 max-md:mb-4 max-md:text-5xl max-md:leading-12 w-[500px] max-xl:w-[400px] max-md:w-[300px]">
          ...
          max-lg:translate-y-40 max-md:-translate-y-28 ">
